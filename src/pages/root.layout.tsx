      ...
      <header className="py-8">
        <div className="container">
          <div className="flex flex-col gap-y-4 items-center justify-center">
            <img className="h-60 w-60 rounded-full select-none mb-4" src={ava} alt="Dzmitry Kaptsiuh" />
            <h1 className="font-medium text-3xl">
              Dzmitry <span className="text-blue-600">Kaptsiuh</span>
            </h1>
      ...
      <footer className="shadow-inner">
        <div className="container text-center py-5 text-sm">
          <p>
            ...
            &nbsp;
            <a href="https://github.com/Kaptsiuh" className="tracking-wide font-medium uppercase text-xs">
              Dzmitry Kaptsiuh
            </a>
          </p>
